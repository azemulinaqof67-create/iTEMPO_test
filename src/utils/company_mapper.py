...
_COMPANY_REGISTRY = {
    "technotron": {"keywords": ["технотрон"], "full_names": ['АО "ПТФК "Технотрон"', "АО «ПТФК «ТЕХНОТРОН»"]},
    "metiz": {"keywords": ["метиз"], "full_names": ['ООО "Технотрон-Метиз"', "ООО «Технотрон-Метиз»"]},
    "kmk": {"keywords": ["кмк", "тэмпо"], "full_names": ['АО "КМК "ТЭМПО"', "АО «КМК «ТЭМПО»"]},
    "ntz": {"keywords": ["нтз", "тэм-по"], "full_names": ['АО "НТЗ "ТЭМ-ПО"', "АО «НТЗ «ТЭМ-ПО»"]},
    "itz": {"keywords": ["итз"], "full_names": ['АО "ИТЗ"', "АО «ИТЗ»"]},
    "kzmk": {"keywords": ["кзмк"], "full_names": ["АО «КЗМК «ТЭМПО»", 'АО "КЗМК "ТЭМПО"']},
    "zteo": {"keywords": ["зтэо"], "full_names": ['АО "ПТФК "ЗТЭО"', "АО «ПТФК «ЗТЭО»"]},
    "td": {"keywords": ["тд", "торговый"], "full_names": ['АО "ТД "ТЭМПО"', "АО «ТД «ТЭМПО»"]},
    "sks": {"keywords": ["скс"], "full_names": ['ООО "СКС"', "ООО «СКС»"]},
    "port": {"keywords": ["порт"], "full_names": ['ООО "ТЭМПО порт"', "ООО «ТЭМПО порт»"]},
    "it": {"keywords": ["айти"], "full_names": ['ООО "АЙТИ "ТЭМПО"', "ООО «АЙТИ «ТЭМПО»"]},
}
